    ...
    <header className="border-b border-gray-100 bg-white">
      <nav className="max-w-sm mx-auto flex items-center justify-between px-4 h-12">
        <div className="flex gap-4 text-sm font-medium">
          ...
          {session && (
            <>
              <Link href="/wardrobe" className="text-gray-700 hover:text-blue-600 transition-colors">
                Wardrobe
              </Link>
        ...
        <div className="text-sm">
          {session ? (
            ...
            >
              <button type="submit" className="text-blue-600 font-medium hover:text-blue-700 transition-colors">
                Connect Strava
              </button>
            </form>
          )}
